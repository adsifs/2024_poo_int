...
1. O funcionário acessa o módulo de Gerenciamento de Clientes no sistema.
...
### 2.1. Adicionar Cliente
   - a. O funcionário seleciona a opção de adicionar um novo cliente.
   - b. O sistema exibe um formulário para o preenchimento dos dados do cliente.
   - c. O funcionário insere o **nome**, **e-mail** e **telefone** do cliente.
   ...
   - e. Após a validação, o funcionário confirma o registro.
...
### 2.2. Editar Cliente
   - a. O funcionário seleciona um cliente existente na lista para edição.
   - b. O sistema exibe um formulário com os dados atuais do cliente.
   - c. O funcionário altera o **nome**, **e-mail** ou **telefone**, conforme necessário.
   - d. O sistema valida as alterações.
   - e. O funcionário confirma a edição.
...
### 2.3. Visualizar Cliente
   - a. O funcionário seleciona um cliente na lista para visualizar.
   - b. O sistema exibe os detalhes do cliente, incluindo **nome**, **e-mail**, **telefone** e o **histórico de agendamentos** (caso disponível).
   - c. O funcionário pode optar por voltar à lista de clientes ou selecionar uma ação de edição ou exclusão.

### 2.4. Remover Cliente
   - a. O funcionário seleciona um cliente para remover.
   - b. O sistema solicita uma confirmação de remoção.
   - c. O funcionário confirma a remoção.
   - d. O sistema exclui o cliente do banco de dados e exibe uma mensagem de sucesso.

## Fluxos Alternativos

- **2.1.d / 2.2.d. Dados inválidos**:
   - Se algum dado fornecido for inválido, o sistema informa o erro ao funcionário e solicita a correção antes de permitir o cadastro ou edição.

- **2.4.b Cancelar remoção**:
   - O funcionário opta por cancelar a remoção do cliente.
   - O sistema retorna à lista de clientes sem realizar nenhuma alteração.

## Pré-condições

- O funcionário deve estar autenticado no sistema para acessar o módulo de Gerenciamento de Clientes.
